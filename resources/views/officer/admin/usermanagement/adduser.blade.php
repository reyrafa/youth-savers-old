            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <select 
                        ...
                        <?php 
                           $pos = DB::table('position_descriptions')->pluck('id', 'position');
                           foreach($pos as $position_id=>$pos){
                               echo "<option value=$pos {{old(position_id) == $pos? 'selected' : ''}}>$position_id</option>";
                           }
                        ?>
                    </select>
                </div>
                ...
                <div class="col-md-3 mt-2">
                    <button type="submit" id="submit" class="btn btn-primary form-control"><i class="fa fa-pencil" aria-hidden="true"></i>Add Officer</button>
                </div>
            </div>
        </form>
    </div>
