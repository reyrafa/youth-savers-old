...
class FinanceController extends Controller
{
    ...
    Notification::send($user, new StatusAlert($statusData));
        ...
        $transaction_his->save();
         ...
         //approving adding to total deposit
         $totalDeposit = new TotalDepositModel();
         $totalDeposit->relationID = $request->depositor_id;
         $totalDeposit->amount = $transaction->amount;
         $totalDeposit->validatedBy = $request->officer_id;
         $totalDeposit->save();
