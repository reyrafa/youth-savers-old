...
class TransactionController extends Controller
{
    ...
    public function personal_info(){
        ...
        $status_of_transaction = StatusOfTransaction::all();
        $level_of_transaction = LvlOfTransac::all();
        $profile_pic = uploaded_document::all()->where('depositor_id', Auth::user()->id);
        return view('page.profile_update.index', compact('depositor', 'guardians','branch','profile_pic', 'branch_under', 'transaction' , 'status_of_transaction', 'level_of_transaction'));
    }
