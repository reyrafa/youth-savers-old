...
class DepositorController extends Controller
{
    ...
    public function downloadable_forms(){
        return view('page.downloadableforms.index');
    }
    ...
    //viewing of Deposit
    public function viewingDeposit(){
        $totalDeposit = TotalDepositModel::all()->where('relationID', Auth::user()->id);
        ...
        return view('page.viewDeposit.index', compact('totalDeposit', 'amount'));
    }
}
