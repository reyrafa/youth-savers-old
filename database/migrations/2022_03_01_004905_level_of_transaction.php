...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('level_of_transactions')->insert(
            array(
                ['level_description'=> 'OIC Personnel', 'level_of_transaction_id' => 1],
                ['level_description' => 'OIC Finance', 'level_of_transaction_id' => 2],
                ['level_description'=> 'OIC Branch', 'level_of_transaction_id' => 3],
