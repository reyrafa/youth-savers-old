...
//route for downloadable forms page
Route::get('/downloadable_forms', [DepositorController::class, 'downloadable_forms'])->name('downloadable_forms')->middleware('depositor', 'auth:sanctum', 'verified');

//validate the fullname
//Route::get('/validateFullName', [ValidateUserIdController::class, 'validateFullName']);
...
Route::post('/import_excel', [ImportExcelController::class, 'index']);

//route to redirect to user management page
Route::get('/admin/user/management', [AdminController::class, 'usermanagement'])->middleware('oic_officer', 'roleAdmin', 'auth:sanctum', 'isDisabled')->name('usermanagement');
...
Route::post('/personnel/approved/application', [PersonnelController::class, 'approve_application'])->middleware('verified', 'auth:sanctum', 'oic_officer', 'rolePersonnel', 'isDisabled');

//route to disapprove or denied application on the personnel dashboard
Route::post('/personnel/denied/application', [PersonnelController::class, 'denied_application'])->middleware('verified', 'auth:sanctum', 'oic_officer', 'rolePersonnel', 'isDisabled');

//route to view each depositor
Route::get('/personnel/view/depositor/{depositor_id}', [PersonnelController::class, 'view_application_depositor'])->middleware('verified', 'auth:sanctum', 'oic_officer', 'rolePersonnel', 'isDisabled');
...
//importing existing ysc member

Route::get('/branch/user/importingMember', [BranchController::class, 'importingExistingMember'])->middleware('verified', 'auth:sanctum', 'oic_officer', 'roleBranch', 'isDisabled');

//viewing total deposit

Route::get('/view/deposit', [DepositorController::class, 'viewingDeposit'])->name('viewDeposit')->middleware('depositor', 'auth:sanctum', 'verified');

Route::get('/export_user_pdf', [ExportController::class, 'toPdf'])->name('exportToPDF');


Route::post('/admin/user/transaction/history2', [AdminController::class, 'history']);

Route::get('/show/depositor/info/print/{depositor_id}', [AdminController::class, 'YSCMmberPrint'])->middleware('oic_officer', 'roleAdmin', 'auth:sanctum', 'isDisabled');

Route::get('/generateExcelDataYSC', [ExportExcelController::class, 'exportMemberExcel']);